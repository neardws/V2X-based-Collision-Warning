...
public class CarManageServiceTest {
    ...
    public void testRemoveCar() {
        ...
        carManageService.addCarInfo("111",new LatLng(0.1d,0.1d),0.0f,0.0f);
        carManageService.addCarInfo("222",new LatLng(0.1d,0.1d),0.0f,0.0f);
        carManageService.addCarInfo("333",new LatLng(0.1d,0.1d),0.0f,0.0f);
        for (int i = 0; i < 30; i++) {
            carManageService.updateCarsLife();
        }
        carManageService.addCarInfo("111",new LatLng(0.1d,0.1d),0.0f,0.0f);
        carManageService.addCarInfo("444",new LatLng(0.1d,0.1d),0.0f,0.0f);
